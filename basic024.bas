...
451 select case cmd
  ...
  case token_wrpin	: compile_fun_2p
  case token_wxpin	: compile_fun_2p
  case token_wypin	: compile_fun_2p
  case token_pinfloat	: compile_fun_1p
  case token_pinlo	: compile_fun_1p
  case token_pinhi	: compile_fun_1p
  case token_pinstart	: compile_fun_4p
  case token_pintoggle 	: compile_fun_1p
  case token_dim	: compile_dim: goto 450
  case token_position	: compile_fun_2p
